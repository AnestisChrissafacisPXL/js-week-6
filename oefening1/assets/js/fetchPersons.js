...
function loaded() {
    ...
    let buttonSetPerson = document.getElementById('button_set_person_name');
    buttonSetPerson.addEventListener("click", handleSetPersonName);
    let buttonPost = document.getElementById('button_post_person');
    buttonPost.addEventListener("click", handlePostPerson);
}

function handleSetPersonName() {
    let url = 'http://localhost:3000/persons/1';
    let output = document.getElementById("div_output");
    let name = document.getElementById("txt_name_input").value;
